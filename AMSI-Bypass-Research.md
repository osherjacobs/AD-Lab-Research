...
Tested 5 progressive obfuscation levels plus manual encoding techniques against AMSI. **All attempts failed.** Key finding: AMSI automatically reverses common obfuscation methods (string concatenation, encoding, compression) and scans the deobfuscated payload in real-time. Things have moved on in the last few years it would seem.....
